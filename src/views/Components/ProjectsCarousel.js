...
//videos
import miccoAp from 'assets/video/micco-webapp.mp4';
  ...
  const projectsArray = [
    {
      ...
      subTitle:
        'React, Material UI, AWS: S3, Cloudfront, Lambda, API Gateway, SES',
      summary: 'Serverless React webapp built on AWS.',
      videoSource: miccoAp,
      githubUrl: 'https://github.com/jprons02/micc-react',
      deployedLink: 'https://www.miccosukee.io/',
      password: 'iomicco',
      hasSound: false,
    },
    {
